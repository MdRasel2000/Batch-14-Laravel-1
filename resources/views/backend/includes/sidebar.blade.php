             ...
             <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                 ...
                 @if (Auth::user()->role == 'admin' || Auth::user()->role == 'editor')
                     <li class="nav-item">
                         ...
                         <ul class="nav nav-treeview">
                             <li class="nav-item">
                                 <a href="{{ url('/admin/product-show') }}" class="nav-link">
                                     <i class="far fa-circle nav-icon"></i>
                                     <p>List</p>
                                 </a>
                             </li>
                 ...
                 <li class="nav-item">
                     ...
                     <ul class="nav nav-treeview">
                         <li class="nav-item">
                             <a href="{{ url('/admin/all-orders/pending') }}" class="nav-link">
                                 <i class="far fa-circle nav-icon"></i>
                                 <p>Pending Order</p>
                             </a>
                         </li>
                         ...
                         <li class="nav-item">
                             <a href="{{ url('/admin/all-orders/confirmed') }}" class="nav-link">
                                 <i class="far fa-circle nav-icon"></i>
                                 <p>Confirmed Order</p>
                             </a>
                         </li>
                         ...
                         <li class="nav-item">
                             <a href="{{ url('/admin/all-orders/delivered') }}" class="nav-link">
                                 <i class="far fa-circle nav-icon"></i>
                                 <p>Delivered Order</p>
                             </a>
                         </li>
                         ...
                         <li class="nav-item">
                             <a href="{{ url('/admin/all-orders/cancelled') }}" class="nav-link">
                                 <i class="far fa-circle nav-icon"></i>
                                 <p>Cancelled order</p>
                             </a>
                         </li>
