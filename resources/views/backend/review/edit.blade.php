                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="{{ $review->name }}" class="form-control"
                                    placeholder="Enter review name*" required>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="{{ $review->product->name }}" class="form-control"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Status*</label>
                                <input type="text" name="status" value="{{ $review->status }}" class="form-control"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="comments" value="{!!$review->comments!!}" class="form-control"
