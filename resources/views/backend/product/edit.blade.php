                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group" id="color_fields">
                               ...
                               <input type="text" name="color[]" id="color" value="{{$colorName->color_name}}" class="form-control"
                        ...
                        <div class="col-md-6">
                            <div class="form-group" id="size_fields">
                               ...
                               <input type="text" name="size[]" id="size" value="{{$sizeName->size_name}}" class="form-control"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="qty" value="{{$product->product_qty}}" class="form-control"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" style="width: 100%;" name="product_type">
                                    <option  value="hot" @if ($product->products_type =='hot' )
                                        selected
                                    @endif>Hot Product</option>
                                    <option value="new" @if ($product->products_type =='new' )
                                        selected
                                    @endif>New Arrival</option>
                                    <option value="regular" @if ($product->products_type =='regular' )
                                        selected
                                    @endif>Regular Product</option>
                                    <option value="discount" @if ($product->products_type =='discount' )
                                        selected
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea id="summernote" name="product_description">{{$product->product_description}}</textarea>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
