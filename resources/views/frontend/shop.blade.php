                ...
                <div class="filter-items-wrapper">
                    ...
                    <div class="filter-items-outer">
                        ...
                        <form class="filter-items" id="collapseOne" action="{{url('/shop-products')}}" method="GET">  
                           ...
                           <div class="item-label">
                            <label>
                                <input type="checkbox" value="{{$category->id}}" id="categoryId" name="categoryId" class="checkbox" onclick="formSubmitCategory()" />
                    ...
                    <div class="filter-items-outer">
                        ...
                        <form class="filter-items" id="collapseTwo" action="{{url('/shop-products')}}" method="GET">
                           ...
                           <div class="item-label">
                            <label>
                                <input type="checkbox" value="{{$subcategory->id}}" id="subcategoryId" name="subcategoryId" class="checkbox" onclick="formSubmitSubCategory() " />
                                <span>
                                    {{$subcategory->name}}
                                </span>
                            </label>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="product__item-outer">
                            <div class="product__item-image-outer">
                                <a href="{{url('/product/dateils/'.$product->slug)}}" class="product__item-image-inner">
                                ...
                                <div class="product__type-badge-outer">
                                    <span class="product__type-badge-inner">
                                       {{ucfirst($product->products_type)}}
                                    </span>
                                </div>
                            </div>
                            <div class="product__item-info-outer">
                                <a href="{{url('/product/dateils/'.$product->slug)}}" class="product__item-name">
                                    {{$product->name}}
                                </a>
